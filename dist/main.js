...
let addProjectContentStructure = (project) => {
    ...
    /*Task table content*/
    let projectTasks = _mainObjects__WEBPACK_IMPORTED_MODULE_1__.mainDatabase.getProjectTasks(project.title)
    ...
    projectTasks.forEach(task => {
        ...
        ;(0,_modal__WEBPACK_IMPORTED_MODULE_3__.createModalStructure)((0,_taskModal_js__WEBPACK_IMPORTED_MODULE_2__.readTask)(task),'modal','Information of the task',dateValue)
...
let createTaskStructure = (project) => {
    ...
    let addButton = (0,_domCreators__WEBPACK_IMPORTED_MODULE_1__.createDomElement)('input','addTask','addProject','Add project');
...
let readTask = (task) => {
    ...
    /* Creates Top part Container */
    let topContainer = (0,_domCreators__WEBPACK_IMPORTED_MODULE_1__.createDOMContainer)('','topTaskModalContainer')
    topContainer.style.background = _mainObjects__WEBPACK_IMPORTED_MODULE_2__.mainDatabase.getProjectByTitle(task.projectTitle).color
    ...
    /*Project Name*/
    let projectName = (0,_domCreators__WEBPACK_IMPORTED_MODULE_1__.createDomElement)('div','taskProjectTitle','taskProjecTitle',_mainObjects__WEBPACK_IMPORTED_MODULE_2__.mainDatabase.getProjectByTitle(task.projectTitle).title
    )
    topContainer.appendChild(projectName)
    ...
    let minDate = new Date().toISOString().split('T')[0];
    let maxDate =  _mainObjects__WEBPACK_IMPORTED_MODULE_2__.mainDatabase.getProjectByTitle(task.projectTitle).dueDate;
