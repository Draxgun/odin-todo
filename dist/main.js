...
let addProjectContentStructure = (project) => {
    ...
    /*Task table content*/
    let projectTasks = _mainObjects__WEBPACK_IMPORTED_MODULE_1__.mainDatabase.getProjectTasks(project)
...
let loadProjectCollapsible = () => {
    ...
    projectTitles.forEach(project => {
        ...
        console.log(_mainObjects__WEBPACK_IMPORTED_MODULE_2__.mainDatabase.getProjectByTitle(project))
